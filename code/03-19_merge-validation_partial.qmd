...
- slope: lowest (c)
- aspect: highest (a)
- eca shallow: second highest (b)
- eca deep: highest (a)

Low-stable areas have:
- elevation: lowest (c/d)
- slope: second highest/middle (b)
- aspect: lowest (c)
- eca shallow: lowest (c) 
- eca deep: lowest (c)

Unstable areas have:  
- elevation: mid-low (c)
- eca shallow: low (c)
- eca deep: low (c). things change because we follow the professor's graphs 
- slope:  mid low
- aspect: low (c)/ middle 
